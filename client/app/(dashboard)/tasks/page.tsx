  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Button variant="outline" onClick={fetchTasks} disabled={loading} className="shrink-0">
                                ...
                                <div className="flex-shrink-0 pt-1 sm:pt-0">
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <button className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${task.status === 'done' ? 'bg-green-500 border-green-500 text-white' : 'border-slate-300 hover:border-blue-500 text-transparent hover:text-blue-500'}`}>
